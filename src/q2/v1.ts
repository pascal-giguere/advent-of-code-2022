...
export type StrategyGuideV1 = RoundV1[];

/** @returns New strategy guide object with decrypted shape values using "V1" decryption */
export function decryptStrategyGuideV1(encryptedGuide: EncryptedStrategyGuide): StrategyGuideV1 {
...
export function calculateStrategyGuidePointsV1(guide: StrategyGuideV1): number {
